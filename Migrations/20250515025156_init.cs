        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamTopics_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ExamTopicId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comments_ExamTopics_ExamTopicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamSections_ExamTopics_ExamTopicsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advises_UserId",
                table: "Advises",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_ExamTopicId",
                table: "Comments",
                column: "ExamTopicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSections_ExamTopicsId",
                table: "ExamSections",
                column: "ExamTopicsId");
